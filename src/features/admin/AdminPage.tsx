...
export default function AdminPage() {
  ...
  const menuUrl = window.location.origin + "/" + restaurant.slug + "?source=qr";
      ...
      <div className="max-w-4xl mx-auto">
        <header className="flex flex-col md:flex-row md:items-center justify-between mb-12 gap-4">
          ...
          <div className="flex gap-3">
            ...
            <Link
              to={"/" + restaurant.slug + "/admin/statistics"}
        ...
        <Link
          to={"/" + restaurant.slug + "/admin/statistics"}
          aria-label="Open QR scan statistics"
          className="group mb-6 flex items-center justify-between rounded-3xl border border-stone-200 bg-white p-6 shadow-sm transition-colors hover:border-stone-400"
        >
          <div>
            ...
            <p className="text-sm text-stone-500">
              Number of times your menu was scanned or viewed this month. View
              the complete daily history.
            </p>
          </div>
          <div className="rounded-xl bg-stone-100 px-4 py-2 flex min-w-[80px] items-center justify-center transition-colors group-hover:bg-stone-900 group-hover:text-white">
            <span className="text-2xl font-bold font-mono text-stone-900 group-hover:text-white">
